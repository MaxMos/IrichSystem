...
Controller.prototype.request = function( url, data = null, type = "POST" ){
	let signObj = {};
	if( data !== null ){
		...
		data.signature 	=	crypto.createHash( "sha1" ).update( JSON.stringify( signObj ) ).digest( "hex" );
	}
	return http.request({
		type	:	type,
